...
const HeroTilted = () => {
  ...
  // Create parallax values for each panel
  ...
  return (
    ...
    >
        ...
        {heroImages.map((src, index) => (
          <motion.div
            ...
            style={{ 
              ...
              rotateZ: index % 2 === 0 ? "-3deg" : "3deg",
            }}
            initial={{ opacity: 0, y: 100, rotateY: index % 2 === 0 ? -25 : 25, rotateZ: index % 2 === 0 ? -8 : 8 }}
            animate={isInView ? { 
              opacity: 1, 
              y: 0, 
              rotateY: index % 2 === 0 ? "-12deg" : "12deg",
      ...
      {/* Hero Content - Also tilted for consistency */}
      <motion.div
        className="absolute left-12 top-1/2 -translate-y-1/2 z-10 text-left px-6 max-w-xl text-white transform -rotate-3"
        initial={{ opacity: 0, x: -40, rotateZ: -10 }}
        animate={isInView ? { opacity: 1, x: 0, rotateZ: -3 } : {}}
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <motion.p
            ...
            initial={{ opacity: 0, y: 10, rotateZ: -2 }}
            animate={isInView ? { opacity: 1, y: 0, rotateZ: 0 } : {}}
          ...
          {/* CTA Buttons - Also slightly tilted */}
          <motion.div
            className="mt-8 flex gap-4 transform rotate-2"
            initial={{ opacity: 0, rotateZ: -3 }}
            animate={isInView ? { opacity: 1, rotateZ: 2 } : {}}
      ...
      {/* Scroll indicator - Also tilted */}
      <motion.div 
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10 text-amber-300 flex flex-col items-center rotate-6"
        initial={{ opacity: 0, rotateZ: 10 }}
        animate={isInView ? { opacity: 1, rotateZ: 6 } : {}}
        transition={{ delay: 2 }}
      >
